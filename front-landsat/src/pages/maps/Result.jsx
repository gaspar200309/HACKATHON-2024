...
import { Calendar, Clock, Download, Cloud, Satellite, MapPin, ThermometerSun } from 'lucide-react';
...
const Result = ({ selectedLocation }) => {
  ...
  const downloadCSV = () => {
    ...
    const data = [
      ...
      ...landSatData.spectralData.map(d => [d.wavelength, d.reflectance, d.band])
    ];
      ...
      <div className="card">
        ...
        <div className="card-content">
          <div className="grid-cols">
            <div>
              <p><Calendar className="icon-small" /> Fecha: {landSatData.acquisitionDate}</p>
              <p><Clock className="icon-small" /> Hora: {landSatData.acquisitionTime}</p>
              <p><Cloud className="icon-small" /> Cobertura de nubes: {landSatData.cloudCover}%</p>
            </div>
            <div>
